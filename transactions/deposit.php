...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO transactions (account_id, transaction_type, amount, reference_number, status) VALUES (?, 'deposit', ?, ?, 'completed')");
...
<head>
    ...
    <title>Deposit - CowryWise Demo</title>
                    ...
                    <div class="card-body">
                        <?php if ($success): ?>
                            <div class="alert alert-success">
                                Deposit successful! <a href="../dashboard.php">Return to Dashboard</a>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mb-1">Current Balance: ₦<?php echo number_format($account['balance'], 2); ?></p>
                        </div>
